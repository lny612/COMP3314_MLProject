...
from utils.tree_to_dict import sklearn_tree_to_dict
                ...
                for dataset in [
                    ...
                    if use_streed:
                        filename = generate_tmp_cost_csv(
                            ...
                            filename=f"experiments/configs/tmp_{i}_{cost_sens_scalar}.csv"
                        )
                        misclass_cost = 1
                    ...
                    results.to_csv(f'experiments/output_0/cost_optimization_{i}_warm_start_cost_{cost_sens_scalar}_{alpha}_{gamma}_{exploration_rate}.csv', index=False)
...
if __name__ == "__main__":
    ...
    for cost_sens_scalar in [0]: # For qlearning exploration_rate, alpha, gamma
